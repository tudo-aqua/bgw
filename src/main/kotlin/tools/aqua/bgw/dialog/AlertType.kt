...
enum class AlertType {
	...
	/**
	 * The INFORMATION alert type configures the Alert dialog to appear in a way that suggests the content of the dialog
	 * is informing the user of a piece of information. This includes an 'information' image, an appropriate title and
	 * header, and just an OK button for the user to click on to dismiss the dialog.
	 */
	INFORMATION,
