...
// Message
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY) sealed class Message
...
data class EndGameResponse(val status: GameMessageStatus, val errorMessages: List<String>?) :
    Response() // TODO error message
...
data class UserDisconnectedNotification(val goodbyeMessage: String, val sender: String) :
    Notification()
