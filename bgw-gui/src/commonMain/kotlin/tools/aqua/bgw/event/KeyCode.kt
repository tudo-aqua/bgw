...
enum class KeyCode(
    val string: String,
    private val keyTypeMask: Int,
    internal val keyCodes: List<String> = listOf(string, string.lowercase(), string.uppercase())
) {
  ...
  /**
   * Constant for the Microsoft Windows Win key. It is used for both the left and right version of
   * the key.
   */
