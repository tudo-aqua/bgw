...
object ContainerNodeBuilder {
    ...
    internal fun buildContainer(
        ...
        return when (container) {
            is CameraPane -> buildBoard(scene, container)
            else -> Pane().apply {
    ...
    private fun buildBoard(
        scene: Scene<out ComponentView>,
        container: CameraPane<out DynamicComponentView>
    ): Region {
        val node = ZoomableScrollPane(Pane().apply {
            this.minWidth = container.contentWidth
            this.minHeight = container.contentHeight
