...
internal class HexGridGameScene : BoardGameScene() {
        ...
        if (q + r >= -5 && q + r <= 5) {
          ...
          val hexagon =
              HexagonView(visual = ColorVisual.LIGHT_GRAY, size = 40).apply {
                ...
                onDragGestureEntered = { visual = ColorVisual.GRAY }

                onDragGestureExited = { visual = ColorVisual.LIGHT_GRAY }
              }
          hexGrid[q, r] = hexagon
  ...
  init {
    ...
    //        repeat(20) {
    //            val hexagon = HexagonView(posX = 800, posY = 800, visual =
    // ImageVisual("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwc4YbxNBYXWRkgqzh9tbaSQh2Uy-f4e1Nl0teHHWFisub3gxv4rxn1eFjgVUUMASaNSg&usqp=CAU"), size = 40, orientation = HexOrientation.FLAT_TOP).apply {
    //                isDraggable = true
    //                onKeyPressed = {
