...
internal fun main() {
  val application =
      object : BoardGameApplication() {
        val scene =
            object : BoardGameScene(1920.0, 1080.0, ColorVisual.GREEN) {
              val label =
                  Label(
                      posX = 0,
                      posY = 0,
                      visual =
                          CompoundVisual(
                              ...
                              // ColorVisual(Color.GREEN).apply { style.borderRadius =
                              // BorderRadius(10,0,5,0) },
                              TextVisual(
                                  "Hello World",
                                  font =
                                      Font(
        ...
        val scene2 =
            object : BoardGameScene(1920.0, 1080.0, ColorVisual.YELLOW) {
              val label2 =
                  Label(
                      posX = 500,
                      posY = 500,
              ...
              val pane =
                  Pane<ComponentView>(
                      posX = 400, posY = 0, visual = ColorVisual.MAGENTA, width = 300, height = 500)
              val button =
                  Button(
                      posX = 50,
                      posY = 50,
