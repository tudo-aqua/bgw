...
mavenMetadata {
  name.set("BoardGameWork Performance Example")
  description.set("The BGW Performance example.")
}
...
application { mainClass.set("tools.aqua.bgw.examples.performance.main.MainKt") }
