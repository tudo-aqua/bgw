...
class RefreshViewController(private val viewController: MauMauViewController) : Refreshable {
  ...
  override fun onShuffleStackReceived() {
    viewController.apply {
      ...
      // update labels
      mauMauGameScene.drawStackInfo.textProperty.value = logicController.game.drawStack.size().toString()
      mauMauGameScene.gameStackInfo.textProperty.value = logicController.game.gameStack.cards.peek().cardSuit.toString()
    }
  }
