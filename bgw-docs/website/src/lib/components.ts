...
function randomHexColor() {
  ...
  return (
    "#" +
    Array.from({ length: 6 }, () => alph[Math.floor(Math.random() * 16)]).join(
      ""
    )
  );
}
...
export class ComponentViewData extends PropData {
  ...
  /* ✅ Done */ opacity: NumberValue = new NumberValue(
    "opacity",
    1.0,
    "Opacity"
  );
  /* ✅ Done */ isVisible: BooleanValue = new BooleanValue(
    "isVisible",
    true,
    "Visible"
  );
  /* ✅ Done */ isDisabled: BooleanValue = new BooleanValue(
    "isDisabled",
    false,
    "Disabled"
  );
  /* 🆔 BGW  */ isFocusable: BooleanValue = new BooleanValue(
    "isFocusable",
    true,
    "Focusable"
  );
  ...
  /* ✅ Done */ rotation: NumberValue = new NumberValue(
    "rotation",
    0.0,
    "Rotation"
  );
  /* ✅ Done */ layoutFromCenter: BooleanValue = new BooleanValue(
    "isLayoutFromCenter",
    false,
    "Layout from Center"
  );
  /* ✅ Done */ isDraggable: BooleanValue = new BooleanValue(
    "isDraggable",
    false,
    "Draggable"
  );
...
export class LabeledUIComponentData extends UIComponentData {
  ...
  /* ✅ Done */ alignment: { first: string; second: string } = {
    first: "center",
    second: "center",
  };
  /* ✅ Done */ horizontalAlignment: ChoiceValue = new ChoiceValue(
    "horizontalAlignment",
    "Center",
    ["Left", "Center", "Right"],
    "Horizontal Alignment"
  );
  /* ✅ Done */ verticalAlignment: ChoiceValue = new ChoiceValue(
    "verticalAlignment",
    "Center",
    ["Top", "Center", "Bottom"],
    "Vertical Alignment"
  );
  /* ✅ Done */ isWrapText: BooleanValue = new BooleanValue(
    "isWrapText",
    false,
    "Wrap Text"
  );
...
class BinaryStateButtonData extends LabeledUIComponentData {
  /* ✅ Done */ isSelected: BooleanValue = new BooleanValue(
    "isSelected",
    false,
    "Selected"
  );
  /* ✅ Done */ group: StringValue = new StringValue(
    "group",
    generateId(),
    "Group"
  );
...
class CheckBoxData extends LabeledUIComponentData {
  /* ✅ Done */ isChecked: BooleanValue = new BooleanValue(
    "isChecked",
    false,
    "Checked"
  );
  /* ✅ Done */ allowIndeterminate: BooleanValue = new BooleanValue(
    "allowIndeterminate",
    false,
    "Allow Indeterminate"
  );
  /* ✅ Done */ isIndeterminate: BooleanValue = new BooleanValue(
    "isIndeterminate",
    false,
    "Indeterminate"
  );
...
class ColorPickerData extends UIComponentData {
  /* ✅ Done */ selectedColor: ColorValue = new ColorValue(
    "initialColor",
    "#FFFFFF",
    "Initial Color"
  );
...
class ProgressBarData extends UIComponentData {
  /* ✅ Done */ progress: NumberValue = new NumberValue(
    "progress",
    0.0,
    "Progress"
  );
  /* ✅ Done */ barColor: ColorValue = new ColorValue(
    "barColor",
    "#00FFFF",
    "Bar Color"
  );
...
class StructuredDataViewData extends UIComponentData {
  /* ✅ Done */ items = [];
  /* ✅ Done */ selectionMode: ChoiceValue = new ChoiceValue(
    "selectionMode",
    "Single",
    ["Single", "Multiple", "None"],
    "Selection Mode"
  );
  /* ✅ Done */ selectionBackground: ColorValue = new ColorValue(
    "selectionBackground",
    "#0000FF",
...
class ListViewData extends StructuredDataViewData {
  /* ✅ Done */ orientation: ChoiceValue = new ChoiceValue(
    "orientation",
    "Vertical",
    ["Vertical", "Horizontal"],
    "Orientation"
...
class CardViewData extends GameComponentViewData {
  ...
  /* ✅ Done */ current: ChoiceValue = new ChoiceValue(
    "current",
    "Front",
    ["Front", "Back"],
    "Current Visual"
...
export class DiceViewData extends GameComponentViewData {
  /* ✅ Done */ sideCount: NumberValue = new NumberValue(
    "sideCount",
    1,
    "Side Count"
  );
  /* ✅ Done */ currentSide: ChoiceValue = new ChoiceValue(
    "currentSide",
    "1",
    ["1"],
    "Current Side"
...
class HexagonGridData extends GameComponentContainerData {
  /* ✅ Done */ coordinateSystem: ChoiceValue = new ChoiceValue(
    "coordinateSystem",
    "Offset",
    ["Axial", "Offset"],
    "Coordinate System"
  ...
  /* ✅ Done */ spacing: NumberValue = new NumberValue(
    "spacing",
    0,
    "Spacing",
    true
...
export class SingleLayerVisualData extends VisualData {
  /* ✅ Done */ transparency: NumberValue = new NumberValue(
    "transparency",
    1.0,
    "Transparency"
  );
  ...
  /* ✅ Done */ flipped: ChoiceValue = new ChoiceValue(
    "flipped",
    "None",
...
export class ImageVisualData extends SingleLayerVisualData {
  ...
  /* ✅ Done */ offsetX: NumberValue = new NumberValue(
    "offsetX",
    0,
    "Offset X"
  );
  /* ✅ Done */ offsetY: NumberValue = new NumberValue(
    "offsetY",
    0,
    "Offset Y"
  );
...
export class CompoundVisualData extends VisualData {
  /* ✅ Done */ children: SingleLayerVisualData[] = [new ColorVisualData()];
...
export class FontData {
  ...
  /* ✅ Done */ family: StringValue = new StringValue(
    "family",
    "Arial",
    "Family"
  );
  /* ✅ Done */ fontWeight: ChoiceValue = new ChoiceValue(
    "fontWeight",
    "400",
    ["100", "200", "300", "400", "500", "600", "700", "800", "900"],
    "Weight"
  );
  /* ✅ Done */ fontStyle: ChoiceValue = new ChoiceValue(
    "fontStyle",
    "Normal",
