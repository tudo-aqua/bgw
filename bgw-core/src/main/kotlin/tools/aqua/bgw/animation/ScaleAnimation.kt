...
class ScaleAnimation<T : ComponentView>(
	 ...
	 */
	constructor(componentView: T, byScaleX: Number = 0.0, byScaleY: Number = 0.0, duration: Int = 1000) : this(
	 ...
	 * @param duration [Animation] duration in milliseconds. Default: 1 second
	 */
	constructor(componentView: T, byScale: Number = 0.0, duration: Int = 1000) : this(
		componentView = componentView,
