 ...
 * @param dragTargets [List] of all [ComponentView]s that accepted the drag gesture in case of a dragGestureEnded
 * [Event]. Contains all accepting [ComponentView]s in the order they accepted.
 *
 * @see DragEvent
 */
