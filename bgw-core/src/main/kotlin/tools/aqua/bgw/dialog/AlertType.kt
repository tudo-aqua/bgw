...
enum class AlertType {
	 ...
	 * title and header, and just a [ButtonType.OK] button for the user to click on to dismiss the dialog.
	 */
	INFORMATION,
	 ...
	 * This includes a 'warning' image, an appropriate title and header, and just a [ButtonType.OK] button for the user
	 ...
	 * header, and both [ButtonType.YES] and [ButtonType.NO] buttons for the user to click on to dismiss the dialog.
	 */
	CONFIRMATION,
	
	/**
	 * The [ERROR] alert type configures the Alert dialog to appear in a way that suggests that something has gone wrong.
	 * This includes an 'error' image, an appropriate title and header, and just a [ButtonType.OK] button for the user
	 * to click on to dismiss the dialog.
	 */
	ERROR,
	 ...
	 * This includes an 'exception' image, an appropriate title and header, and just a [ButtonType.OK] button
